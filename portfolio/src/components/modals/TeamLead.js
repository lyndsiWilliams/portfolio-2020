...
// import Modal, { DialogContent, DialogTitle } from "./sharedFunctionality";
import Modal from "./sharedFunctionality";
...
export default function TeamLead() {
  ...
  return (
    <>
      <Modal
        buttonText={`• Bloom Institute of Technology (formerly Lambda School) •${(
          <br />
        )}Team Lead`}
        modalTitle={`Bloom Institute of Technology (formerly Lambda School)${(
          <br />
        )}March 2020 - June 2020`}
        contentTitle={`Team Lead - Remote`}
        contentDescription={
          <>
            <p>
        ...
        <Dialog onClose={handleClose} open={open}>
          ...
          <DialogContent dividers>
            <div className="experience-bullets">
              ...
              <p>• Delivered 1:1 feedback and code review on a weekly basis</p>
              <p>
                • Led a team of 7-9 students that emulates a real work
                environment using Agile methodology
              </p>
              <p>
                • Mentored a team of 7-9 students on how to learn effectively
                and solve programming problems
              </p>
              <p>
                • Reviewed student code and provided detailed feedback on areas
                of improvement
              </p>
              <p>
                • Facilitated daily standup meetings to build camaraderie,
                encourage sharing of ideas and work progress, and provide
