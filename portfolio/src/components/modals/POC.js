  ...
  return (
    <div style={{ marginTop: "2%" }}>
      ...
      <Dialog onClose={handleClose} open={open}>
        ...
        <span style={{ fontFamily: "'Major Mono Display', monospace", fontWeight: 'bold' }}>PRO Unlimited (Electronic Arts)<br/>March 2011 - March 2012, July 2012 - June 2013</span>
        </DialogTitle>
        <DialogContent dividers>
          <div className="experience-bullets">
            <p style={{ textAlign: "center", fontFamily: "'Major Mono Display', monospace", fontWeight: 'bold' }}>Quality Assurance Tester - Baton Rouge LA</p>
            ...
            <p style={{ textAlign: "center", fontFamily: "'Major Mono Display', monospace", fontWeight: 'bold', marginTop: "10%" }}>Point of Contact - Baton Rouge LA</p>
