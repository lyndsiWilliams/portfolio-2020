    ...
    <div>
      ...
      <Dialog onClose={handleClose} open={open}>
        <DialogTitle onClose={handleClose} >
          <span style={{ fontFamily: "'Major Mono Display', monospace", fontWeight: 'bold' }}>Lambda School<br/>March 2020 - June 2020</span>
        </DialogTitle>
        <DialogContent dividers>
          <div className="experience-bullets">
            <p style={{ textAlign: "center", fontFamily: "'Major Mono Display', monospace", fontWeight: 'bold' }}>Team Lead - Remote</p>
